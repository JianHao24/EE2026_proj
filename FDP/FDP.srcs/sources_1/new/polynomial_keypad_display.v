...
// Create Date: 
// Design Name: 
// Module Name: polynomial_keypad_display
// Project Name: 
// Target Devices: 
// Tool Versions: 
// Description: Keypad display for polynomial mode - similar to arithmetic keypad
//              but with different button labels (Coeff selection and Mode selection)
// 
// Dependencies: 
// 
// Revision:
...
module polynomial_keypad_display(
    input clk,
    ...
    always @(*) begin
        ...
        if (in_keypad) begin
            ...
            case({btn_row, btn_col})
                ...
                {2'd3, 2'd2}: display_char = 6'd11; // - (negative sign)
            ...
            // ===== RIGHT UPPER BUTTON (Coefficient Selection) =====
            display_char = 6'd3; // C (for Coefficient)
            ...
            // ===== RIGHT LOWER BUTTON (Mode Selection) =====
            display_char = 6'd6; // F (for Function mode: f(x) or f'(x))
